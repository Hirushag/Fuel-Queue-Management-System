...
public class FuelStation extends Fragment {
    ...
    private List<com.example.application_mobile.model.FuelStation> stationsList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fuel_stations_list, container, false);
